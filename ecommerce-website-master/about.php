...
<head>
  ...
  <title>As Salih Production</title>
...
<body style="overflow-x:hidden; padding-bottom:100px;">
    ...
    <div class="container mt-5 ">
      <div class="row justify-content-around">
        <div class="col-md-5 mt-3">
          ...
          <hr />
          <img
            src="https://img.freepik.com/vecteurs-libre/industrie-impression-conception-plate_23-2148887522.jpg?w=740&t=st=1659313748~exp=1659314348~hmac=37dbad8ef278bc5e9bb37b9f4916566a3bfd418ec600ea2f0f9fda6d74d9ed7a"
  ...
  <div class="container mt-3 d-flex justify-content-center card pb-3 col-md-6">
    ...
    <form class="col-md-12" action="https://formspree.io/EnterYourEmail" method="POST" name="_next">
      <h3 class="text-warning pt-3 title mx-auto"> Newsletter </h3>
